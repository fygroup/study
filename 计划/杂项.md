...
public:
    Reflect(T Obj::* var_):ReflectVarBase<Obj>(reinterpret_cast<void* Obj::*>(var_)){}
...
static map<std::string, const int> _map = {{"a",1}, {"b", 2}, {"c",3}};

constexpr int getMap(const string & str){
        return _map[str];
}

template<int a> struct func {};
